...
export const CALL_TO_ACTION_DATA = {
  title:
    "Enjoy fast delivery from\n your favourite restuaranrts. Just order and relax",
  text: "We have got some of the best restuarants in Lagos to select from. You can order any food of your choice with just few easy steps",
...
export const DELIVERY_PRODUCT_DATA = {
  sectionContent: {
    title: "We deliver your packages in a flash",
...
export const HOW_WORKS_DATA = {
  ...
  posts: [
    ...
    },
    {
      ...
      text: "Get the best Onwl experience with live order tracking.",
      link: {
        label: "Get the app",
        path: "#",
      },
