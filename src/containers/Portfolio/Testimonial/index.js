  ...
  return (
    <Box className="con" {...sectionWrapper} as="section">
      <Container noGutter mobileGutter width="1200px">
        <Box {...secTitleWrapper}>
          <Heading className="conta" {...secTitle} content="My Experience" />
          <Text
            className="conta"
            {...secDescription}
            content="My experience section showcases my data analysis skills and proficiency in machine learning, featuring relevant projects and AWS technologies for cutting-edge solutions."
          />
        </Box>
        <TestimonialWrapper>
          <GlideCarousel
