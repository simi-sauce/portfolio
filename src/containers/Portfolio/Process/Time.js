    ...
    <>
      ...
      >
        <div style={overlayStyle}>
          <div style={projectNameStyle}>Time Series Project</div>
          <div style={proposalNameStyle}>Forecasting Danyyen Stock Prices</div>
        </div>
      </Box>
      <Modal
        isOpen={modalIsOpen}
      ...
      >
        <iframe
          ...
          src="/Time_Series-Project.pdf#toolbar=0"
          width="100%"
          height="550px"
